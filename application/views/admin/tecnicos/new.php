  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3 class="mt-4"><i class="fa fa-angle-right"></i> Técnico <a href="<?=base_url()?>admin/tecnicos" class="btn btn-info"><i class="fa fa-arrow-left"></i></a></h3>
        <div class="row mt">
          <div class="col-lg-12">
            <div class="card h-100">
              ...
              <div class="card-body">
                <form id="formFile" action="<?=base_url()?>servicios/newTecnico" class="user needs-validation" method="POST" enctype="multipart/form-data" onsubmit="return false" novalidate target="my_iframe">
                  <div class="row">
                    <div class="col-12 col-lg-6 detailed">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col">
                          <input type="text" placeholder="Ingresar la cédula" class="form-control" name="cedula">
                        </div>
                      </div>
                    </div>
                    <div class="col-12 col-lg-6 detailed">
