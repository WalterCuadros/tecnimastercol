...
$data=['nombres'=>$nombre, 'apellidos'=>$apellido, 'municipio'=>$municipio, 'contacto'=>$contacto, 'cedula'=>$cedula, 'email'=>$email, 'direccion'=>$direccion];
...
if ($ok_image) {
    $query=$this->db->insert('tecnicoss', $data);
	if ($query) {
